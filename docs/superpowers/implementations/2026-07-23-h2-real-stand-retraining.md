...
### `2026-07-25_15-03-21/model_19000.pt` 评测
...
正式配置为256 environments、每场景20秒、seed 42。结果保存于：
...
| 指标 | 结果 | 标准 | 判定 |
|---|---:|---:|---|
| 20秒 episode 存活率 | `98.29%` | `>= 90%` | 通过 |
| XY 线速度 RMSE | `0.1637 m/s` | `<= 0.20 m/s` | 通过 |
| Yaw 角速度 RMSE | `0.1569 rad/s` | `<= 0.25 rad/s` | 通过 |
| 非期望接触 episode 比例 | `100%` | `<= 5%` | 失败 |
| Soft-limit invalid rate | `0.6839%` | `<= 0.1%` | 失败 |

分场景结果：

| 场景 | 存活率 | 线速度 RMSE | Yaw RMSE | Invalid rate |
|---|---:|---:|---:|---:|
| stand | `100%` | `0.0104` | `0.0168` | `0.5785%` |
| forward | `100%` | `0.2482` | `0.0942` | `0.5637%` |
| backward | `100%` | `0.1840` | `0.0884` | `0.8234%` |
| left | `100%` | `0.1614` | `0.0864` | `0.5043%` |
| right | `100%` | `0.1722` | `0.0905` | `0.6734%` |
| yaw_left | `100%` | `0.0397` | `0.2532` | `0.5512%` |
| yaw_right | `100%` | `0.0456` | `0.2504` | `0.5887%` |
| mixed | `86.33%` | `0.2514` | `0.1970` | `1.2392%` |
